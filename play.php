...
<html>
    <head>
        <title><?=$result['name']?> EP.<?=$result['main_id']?></title>
        <meta charset="UTF-8">
...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="card mb-4 shadow-sm">
    <iframe width="100%" height="600" src="https://www.youtube.com/embed/<?=$result['video_main']?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
  </div> 
</div>
  <!-- movie end -->
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.php" class="text-decoration-none">Home</a></li>
    <li class="breadcrumb-item"><a href="list.php?id=<?=$result['main_id']?>" class="text-decoration-none"><?=$result['name']?></a></li>
    <li class="breadcrumb-item active" aria-current="page">ตอนที่ <?=$result['part']?></li>
  </ol>
</nav>
...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="card mb-4 shadow-sm">
    <iframe width="100%" height="600" src="https://www.youtube.com/embed/<?=$result['video']?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
  </div> 
</div>
  <!-- movielist end -->
